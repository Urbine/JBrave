 ...
 *
 * @param vertical The vertical or category of the search result.
 * @param callbackKey A key used to identify the specific callback.
 */
public record RichCallbackHint(String vertical, String callbackKey) {}
