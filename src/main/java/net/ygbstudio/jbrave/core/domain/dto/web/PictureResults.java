 ...
 * more results.
 *
 * @param viewMoreUrl A URL where more image results can be viewed.
 * @param results A list of thumbnail images that match the search query.
 */
public record PictureResults(String viewMoreUrl, List<Thumbnail> results) {}
